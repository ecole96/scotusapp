<?php
    ...
    function buildQuery($connect,$title_query,$text_query,$keyword_query,$bool_search,$dateFrom,$dateTo,$source_search,$ID_search,$sourcebox,$mode) {
        ...
        if($mode == 'download') {
            ...
            IFNULL(sa.similarBefore,''), IFNULL(sa.similarAfter,''), IFNULL(a.fb_reactions_initial,''), IFNULL(a.fb_reactions_d1,''), IFNULL(a.fb_reactions_d7,''), IFNULL(a.`fb_reactions_d8+`,''), IFNULL(a.fb_comments_initial,''), IFNULL(a.fb_comments_d1,''), IFNULL(a.fb_comments_d7,''), IFNULL(a.`fb_comments_d8+`,''),
            IFNULL(a.fb_shares_initial,''), IFNULL(a.fb_shares_d1,''), IFNULL(a.fb_shares_d7,''), IFNULL(a.`fb_shares_d8+`,''), IFNULL(a.fb_comment_plugin_initial,''), IFNULL(a.fb_comment_plugin_d1,''), IFNULL(a.fb_comment_plugin_d7,''), IFNULL(a.`fb_comment_plugin_d8+`,''), IFNULL(a.tw_tweets_initial,''), IFNULL(a.tw_tweets_d1,''), IFNULL(a.tw_tweets_d7,''), 
            ...
            IFNULL(a.tw_top_favorites_d7,''), IFNULL(a.tw_top_retweets_initial,''), IFNULL(a.tw_top_retweets_d1,''), IFNULL(a.tw_top_retweets_d7,''), IFNULL(a.rdt_posts_initial,''), IFNULL(a.rdt_posts_d1,''), IFNULL(a.rdt_posts_d7,''), IFNULL(a.`rdt_posts_d8+`,''), IFNULL(a.rdt_total_comments_initial,''), 
            IFNULL(a.rdt_total_comments_d1,''), IFNULL(a.rdt_total_comments_d7,''), IFNULL(a.`rdt_total_comments_d8+`,''), IFNULL(a.rdt_total_scores_initial,''), IFNULL(a.rdt_total_scores_d1,''), IFNULL(a.rdt_total_scores_d7,''), IFNULL(a.`rdt_total_scores_d8+`,''), IFNULL(a.rdt_top_comments_initial,''), IFNULL(a.rdt_top_comments_d1,''), 
            IFNULL(a.rdt_top_comments_d7,''), IFNULL(a.`rdt_top_comments_d8+`,''), IFNULL(a.rdt_top_score_initial,''), IFNULL(a.rdt_top_score_d1,''), IFNULL(a.rdt_top_score_d7,''), IFNULL(a.`rdt_top_score_d8+`,''), IFNULL(a.rdt_top_ratio_initial,''), IFNULL(a.rdt_top_ratio_d1,''), IFNULL(a.rdt_top_ratio_d7,''), IFNULL(a.`rdt_top_ratio_d8+`,''),
            IFNULL(a.rdt_avg_ratio_initial,''), IFNULL(a.rdt_avg_ratio_d1,''), IFNULL(a.rdt_avg_ratio_d7,''), IFNULL(a.`rdt_avg_ratio_d8+`,''), IFNULL(sb.mbm_pol_align_very_conservative,''), IFNULL(sb.mbm_pol_align_very_liberal,''), IFNULL(sb.mbm_pol_align_moderate,''), IFNULL(sb.mbm_pol_align_liberal,''), 
